...
function AcordeonPAE() {
    return (
        <>
            ...
            <Accordion>
                <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                        ...
                        <h6>1.- Atención Psicopedagógica:</h6>
                        <ul>
                            <li>
                        ...
                        <br />
                        <h6>2.- Atención Fonoaudiológica:</h6>
                        <ul>
                            <li>
                        ...
                        <br />
                        <h6>4.- Atención Terapeuta Ocupacional:</h6>
                        <ul>
                            <li>
                ...
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                        ...
                        <br />
                        <h6>3.- Atención Psicológica en TDA:</h6>
                        <ul>
                            <li>
                ...
                <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                        <p><strong>Este programa está dirigido al Diagnóstico de Dificultades Específicas del Aprendizaje (DEA)</strong></p>
                        <h6>1.- Adecuaciones Curriculares:</h6>
                        <ul>
                            <li>
            ...
            <h1 className='tituloAcordion'>Consideraciones Generales de los Programas:</h1>
            <ul>
                <li>
